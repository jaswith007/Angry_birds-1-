...
bird1 = bird.Bird(0.22*x_length, 520, 25, "red")
bird2 = bird.Bird(0.23*x_length, 520, 25, "blue")
bird3 = bird.Bird(0.24*x_length, 520, 25, "yellow")
bird4 = bird.Bird(0.25*x_length, 520, 25, "black")
